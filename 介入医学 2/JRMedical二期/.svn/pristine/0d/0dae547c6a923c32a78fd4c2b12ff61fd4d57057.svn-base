...
@interface MedicalMeetTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation MedicalMeetTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            MedicalMeetListVC *tabVC = [[MedicalMeetListVC  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"MedicalCongress";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"MedicalCongress"];
