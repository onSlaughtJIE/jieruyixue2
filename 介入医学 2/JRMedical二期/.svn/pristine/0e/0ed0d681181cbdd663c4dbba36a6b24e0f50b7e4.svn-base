...
@interface MedicalLiteratureTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation MedicalLiteratureTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            MedicalLiteratureListVC *tabVC = [[MedicalLiteratureListVC  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"MedicalLiterature";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"MedicalLiterature"];
