...
//        [weakself.dataArray addObjectsFromArray:aChatroom.members];
//        weakself.occupantsCount = aChatroom.membersCount;
//        weakself.numberLabel.text = [NSString stringWithFormat:@"%@",@(weakself.occupantsCount)];
//        [weakself.collectionView reloadData];
//    } failure:^(EMError *aError) {
//        //加载失败
//    }];
    [[EMClient sharedClient].roomManager getChatroomSpecificationFromServerByID:chatroomId includeMembersList:YES completion:^(EMChatroom *aChatroom, EMError *aError) {
        [weakself.dataArray addObjectsFromArray:aChatroom.members];
        weakself.occupantsCount = aChatroom.membersCount;
        weakself.numberLabel.text = [NSString stringWithFormat:@"%@",@(weakself.occupantsCount)];
        [weakself.collectionView reloadData];
