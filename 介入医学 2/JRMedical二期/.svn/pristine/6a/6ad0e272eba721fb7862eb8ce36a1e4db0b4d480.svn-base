...
#import "ScienceEducationListVC.h"

#import "ScienceEducationCell.h"
#import "LearnWebController.h"

#import "PublicNewsListModel.h"
#import "UITableView+EmpayData.h"

@interface ScienceEducationListVC ()

@end

@implementation ScienceEducationListVC
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ScienceEducationCell class] forCellReuseIdentifier:NSStringFromClass([ScienceEducationCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ScienceEducationCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ScienceEducationCell class]) forIndexPath:indexPath];
    [cell setModel:mode];
    return cell;
}
