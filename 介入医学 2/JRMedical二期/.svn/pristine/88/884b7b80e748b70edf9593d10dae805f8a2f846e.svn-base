...
@interface MyCollectionPostVC ()<UITableViewDelegate,UITableViewDataSource,YHWorkGroupPhotoContainerDelegate,NewesPostFooterViewDelegate>
...
- (void)RefreshPostListStateCollectionClick {
...
- (void)requestListDataArrray {
    ...
    NSString *url = @"api/Customer/MyCollectionPostLst";
    NSString *params = @"";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    _curSection = indexPath.section;//获得当前选择的section
