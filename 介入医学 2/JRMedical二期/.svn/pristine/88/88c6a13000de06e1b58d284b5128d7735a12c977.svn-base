...
@interface DaiPostOrder ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation DaiPostOrder
...
- (void)requestListDataArrray {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCOpeType=%@",@"Delivery"];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    if (self.dataSource == nil) {
        ...
        [tableView tableViewDisplayWitMsg:@"暂无待发货订单信息!" ifNecessaryForRowCount:self.dataSource.count];
