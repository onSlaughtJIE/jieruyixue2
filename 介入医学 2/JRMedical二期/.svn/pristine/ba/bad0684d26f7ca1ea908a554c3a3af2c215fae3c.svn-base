...
@interface ScienceEducationTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation ScienceEducationTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            ScienceEducationListVC *tabVC = [[ScienceEducationListVC  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"PopularScience";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"PopularScience"];
