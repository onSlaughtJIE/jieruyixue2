...
@interface EquipmentSuppliesTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation EquipmentSuppliesTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            EquipmentSuppliesListVC *tabVC = [[EquipmentSuppliesListVC  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"CompanyType";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"CompanyType"];
