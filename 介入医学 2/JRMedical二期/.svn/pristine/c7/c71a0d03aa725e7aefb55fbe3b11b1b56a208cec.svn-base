...
#import "BasicKnowledgeCell.h"
#import "LearnWebController.h"

#import "PublicNewsListModel.h"
#import "UITableView+EmpayData.h"

@interface BasicKnowledgeListVC ()

@end

@implementation BasicKnowledgeListVC
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[BasicKnowledgeCell class] forCellReuseIdentifier:NSStringFromClass([BasicKnowledgeCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BasicKnowledgeCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([BasicKnowledgeCell class]) forIndexPath:indexPath];
    [cell setModel:mode];
    return cell;
}
