...
{
    if (_textField == nil) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(10, 10, Width_Screen - 20, 40)];
...
{
    if (_textView == nil) {
        _textView = [[EMTextView alloc] initWithFrame:CGRectMake(10, 70, Width_Screen - 20, 80)];
...
//        [_switchView addSubview:switchControl];
        ...
        _groupTypeLabel = [[UILabel alloc] initWithFrame:CGRectMake(105, oY, 100, 35)];
