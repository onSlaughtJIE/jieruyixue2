...
@implementation MyPostTieZiCell
...
- (void)initJiChuAutoLayout {
    ...
    self.deleteBtn.sd_layout.topSpaceToView(self.contentView,16).rightSpaceToView(self.contentView,10).heightIs(20).widthIs(50);
    self.nameLab.sd_layout.topSpaceToView(self.contentView,20).leftSpaceToView(self.headerPhoto,10).rightSpaceToView(self.deleteBtn,10).heightIs(16);
