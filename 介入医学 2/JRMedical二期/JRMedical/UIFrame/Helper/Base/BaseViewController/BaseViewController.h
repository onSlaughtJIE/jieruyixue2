...
@property (nonatomic, copy)void (^baseFinishBlock)(NSArray *modelData);//表类请求成功后返回的回调Block

@property (nonatomic, assign) NSInteger tableType;//表类型 1 = tableView   2 = colloectionView
...
@property (nonatomic, copy) NSString *tableParamsStr;//请求还需的加密参数
