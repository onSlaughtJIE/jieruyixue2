...
@interface PostAllTypeVC ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) UICollectionView *collectionTopView;

@end

@implementation PostAllTypeVC
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PostAllTypeVCRefreshDataAfterSorting" object:nil userInfo:allInfoDic];
    [self dismissViewControllerAnimated:YES completion:nil];
}
