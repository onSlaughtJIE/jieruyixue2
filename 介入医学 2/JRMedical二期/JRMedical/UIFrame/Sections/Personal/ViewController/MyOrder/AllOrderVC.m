...
@interface AllOrderVC ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    if (self.dataSource == nil) {
        ...
        [tableView tableViewDisplayWitMsg:@"暂无相关订单信息!" ifNecessaryForRowCount:self.dataSource.count];
    }
