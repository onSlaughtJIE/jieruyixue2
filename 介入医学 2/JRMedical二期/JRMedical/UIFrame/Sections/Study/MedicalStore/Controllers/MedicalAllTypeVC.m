...
@interface MedicalAllTypeVC ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) UICollectionView *collectionTopView;

@end

@implementation MedicalAllTypeVC
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MedicalTypeCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MedicalTypeCollectionCell class]) forIndexPath:indexPath];
    
    MerchandiseTypeModel *model = self.typeListArray[indexPath.row];
    [cell setModel:model];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        //定制头部视图的内容
        MedicalCollectionReusableView *headView = (MedicalCollectionReusableView *)[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:NSStringFromClass([MedicalCollectionReusableView class]) forIndexPath:indexPath];
        headView.titleLab.text = @"商品类型";
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MedicalTypeCollectionCell *cell = (MedicalTypeCollectionCell *)[collectionView cellForItemAtIndexPath:indexPath];
    [cell setBackgroundColor:Main_Color];
    cell.titleLab.textColor = [UIColor whiteColor];
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"MedicalTypeRefreshDataAfterSorting" object:nil userInfo:allInfoDic];
    [self dismissViewControllerAnimated:YES completion:nil];
}
...
- (UICollectionView *)collectionTopView {
    if (!_collectionTopView) {
        ...
        [_collectionTopView registerClass:[MedicalTypeCollectionCell class] forCellWithReuseIdentifier:NSStringFromClass([MedicalTypeCollectionCell class])];
        [_collectionTopView registerClass:[MedicalCollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:NSStringFromClass([MedicalCollectionReusableView class])];
    }
