...
@interface VideoMajorTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation VideoMajorTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            VideoMajorListVC *tabVC = [[VideoMajorListVC  alloc]init];
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"VideoLecturesMajor"];
