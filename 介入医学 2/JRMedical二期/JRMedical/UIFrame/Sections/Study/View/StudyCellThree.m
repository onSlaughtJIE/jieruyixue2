...
- (void)setModel:(PublicNewsListModel *)model {
    ...
    [self.Img1 sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.TuPian1]] placeholderImage:[UIImage imageNamed:@"jiazai"]];
     [self.Img2 sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.TuPian1]] placeholderImage:[UIImage imageNamed:@"jiazai"]];
     [self.Img3 sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.TuPian1]] placeholderImage:[UIImage imageNamed:@"jiazai"]];
