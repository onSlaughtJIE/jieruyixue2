...
#import "ClassicCaseListVC.h"

#import "ClassicCaseCell.h"
#import "LearnWebController.h"

#import "PublicNewsListModel.h"
#import "UITableView+EmpayData.h"

@interface ClassicCaseListVC ()

@end

@implementation ClassicCaseListVC
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ClassicCaseCell class] forCellReuseIdentifier:NSStringFromClass([ClassicCaseCell class])];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (self.dataSource == nil) {
        ...
        [tableView tableViewDisplayWitMsg:@"暂无相关案例信息!" ifNecessaryForRowCount:self.dataSource.count];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ClassicCaseCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ClassicCaseCell class]) forIndexPath:indexPath];
    [cell setModel:mode];
    return cell;
}
