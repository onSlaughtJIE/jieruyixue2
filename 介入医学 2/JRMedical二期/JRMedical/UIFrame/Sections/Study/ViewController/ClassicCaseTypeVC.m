...
@interface ClassicCaseTypeVC ()<SCNavTabBarControllerDelegate>
...
@implementation ClassicCaseTypeVC {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            ClassicCaseListVC *tabVC = [[ClassicCaseListVC  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"DiseaseDiagnosis";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"DiseaseDiagnosis"];
