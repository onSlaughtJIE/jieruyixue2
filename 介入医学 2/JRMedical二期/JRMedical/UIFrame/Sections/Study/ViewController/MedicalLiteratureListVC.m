...
#import "MedicalLiteratureListVC.h"

#import "MedicalLiteratureCell.h"
#import "LearnWebController.h"

#import "PublicNewsListModel.h"
#import "UITableView+EmpayData.h"

@interface MedicalLiteratureListVC ()

@end

@implementation MedicalLiteratureListVC
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[MedicalLiteratureCell class] forCellReuseIdentifier:NSStringFromClass([MedicalLiteratureCell class])];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (self.dataSource == nil) {
        ...
        [tableView tableViewDisplayWitMsg:@"暂无相关文献信息!" ifNecessaryForRowCount:self.dataSource.count];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MedicalLiteratureCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([MedicalLiteratureCell class]) forIndexPath:indexPath];
    [cell setModel:mode];
    return cell;
}
