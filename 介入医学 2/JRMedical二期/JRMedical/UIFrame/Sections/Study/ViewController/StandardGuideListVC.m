...
@interface StandardGuideListVC ()

@end

@implementation StandardGuideListVC
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[StandardGuideCell class] forCellReuseIdentifier:NSStringFromClass([StandardGuideCell class])];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (self.dataSource == nil) {
        ...
        [tableView tableViewDisplayWitMsg:@"暂无相关规范信息!" ifNecessaryForRowCount:self.dataSource.count];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    StandardGuideCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([StandardGuideCell class]) forIndexPath:indexPath];
    [cell setModel:mode];
    return cell;
}
