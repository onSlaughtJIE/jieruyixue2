...
@interface StudyTypeViewController ()<SCNavTabBarControllerDelegate>
...
@implementation StudyTypeViewController {
...
- (void)viewDidLoad {
    ...
    self.passLearnArr = ^(NSMutableArray *titleArray, NSMutableArray *groupCodeArray, NSMutableArray *valueArray, NSMutableArray *lableValueLst){
        for (int i = 0; i < titleArray.count; i++) {
            TypeSubController *tabVC = [[TypeSubController  alloc]init];
...
- (void)rightBarButtonItemClick {
    ...
    searchVC.groupCode = @"MedicalCourseware";
...
- (void)requestCategoryData {
    ...
    NSString *params = [NSString stringWithFormat:@"ZICBDYCGroupCode=%@",@"MedicalCourseware"];
