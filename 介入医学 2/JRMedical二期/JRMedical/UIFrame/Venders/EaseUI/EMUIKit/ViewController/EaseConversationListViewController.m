...
//        cell.detailLabel.attributedText =  attributedText;  // jia motify
        
        cell.detailLabel.attributedText =  [[EaseEmotionEscape sharedInstance] attStringFromTextForChatting:(NSString *)[_dataSource conversationListViewController:self latestMessageTitleForConversationModel:model] textFont:cell.detailLabel.font]; // jia motify
